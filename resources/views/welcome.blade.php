...
@section('content')
    <div class="flex flex-col ... cursor-pointer mx-6">
        <div class="md:ml-6">
            <div class="animate-fade-left animate-once flex justify-start w-[40%]">
                <h1 id="text" class="md:text-4xl text-xl text-gray-900">Wellcome To</h1>
            </div>
            ...
            <div class="w-[50%] mb-10">
                <p class="text-xl font-mono animate-fade-right animate-once">Selamat datang di StrawberryCaffe, sebuah tempat yang memukau dan memanjakan indera Anda dengan kehangatan dan pesona yang unik. </p>
            </div>
